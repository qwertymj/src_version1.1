	...
	<div class="span12">
		<div class="portlet box blue">
			<div class="portlet-title">
				<div class="caption"><i class="icon-reorder"></i>修改取款密码</div>
			</div>
			<div class="portlet-body form">
				<form action="/dashboard/change_withdraw_psd" method='post'>
					<!--edit by chenke-->
					...
					<!--edit by chenke-->
					<div class="control-group">
						<label class="control-label">旧取款密码</label>
						<div class="controls">
							<input type="password" class="span6 m-wrap" name="passwdold">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">新取款密码</label>
						<div class="controls">
							<input type="password" class="span6 m-wrap" name="passwdnew">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label">再次输入新取款密码</label>
						<div class="controls">
